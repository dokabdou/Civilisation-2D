...
public class ProductionTest {
	...
	public void multiplyTest() {
		...
		assert (multipliedProduction.getProduction().getResources().size() == 0);
		...
		assertTrue(multipliedProduction2.getProduction().getResources().size() == 2);
		assertTrue(multipliedProduction2.getProduction().getResources().get(0).amount.value == 6);
		assertTrue(multipliedProduction2.getProduction().getResources().get(1).amount.value == 9);
	}
